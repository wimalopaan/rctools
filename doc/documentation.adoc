...
ausführen. Das Programm send_read.mjs befindet sich im Ordner js und bietet die Möglichkeit Mavlink Pakete seriell zu versenden. Auch das Empfangen von Paketen ist mit dem Programm möglich, denn der Inhalt von empfangenen Mavlink wird anhand der Header Informationen geparsed.
